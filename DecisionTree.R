...
model <- tree(TargetTrain1 ~ ., Iteracao1)
...
model <- tree(TargetTrain2 ~ ., Iteracao2)
...
model <- tree(TargetTrain3 ~ ., Iteracao3)
...
model <- tree(TargetTrain4 ~ ., Iteracao4)
...
model <- tree(TargetTrain5 ~ ., Iteracao5)
